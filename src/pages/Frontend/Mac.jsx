...
export default function Mac() {
    return (
        <div className='pt-40 bg-neutral-100'>
            ...
            {/* Video section */}
            <div id="video-container" className="max-w-full mx-auto mt-8 p-10 overflow-hidden">
            ...
            <div className='mt-24 mx-8 pl-24 '>
                <Swiper
                    spaceBetween={-100}
                    slidesPerView={4}
                    direction="horizontal"
                    // style={{ '--swiper-space-between': '4px' }}
                    style={{ '--swiper-slide-margin': '8px' }}
                >
                    {/* Slides */}
                    <SwiperSlide className='pt-5 pb-5'>
                        {/* Card content */}
                        <div className="w-[372px] h-[680px] mx-3 rounded-3xl bg-white shadow-md p-4 transition-transform duration-300 transform hover:scale-105 flex flex-col overflow-visible">
                            <div className="">
                    ...
                    <SwiperSlide className='pt-5 pb-5'>
                        {/* Card content */}
                        <div className="w-[372px] h-[680px] mx-3 rounded-3xl bg-white shadow-md p-4 transition-transform duration-300 transform hover:scale-105 flex flex-col">
                            <div className="">
            ...
            <h1 className='text-5xl text-center mt-10'>Add the products here</h1>
