        ...
        <div className='pt-40 bg-neutral-100'>
            ...
            <div className='mt-10 mx-8 pl-24'>
                ...
                >
                    ...
                    <SwiperSlide className='pt-5 pb-5'>
                        {/* Card content */}
                        <div className="w-[372px] h-[680px] mx-3 rounded-3xl bg-white shadow-md p-4 transition-transform duration-700 transform hover:scale-105 flex flex-col overflow-hidden relative" style={{ backgroundImage: 'url("https://www.apple.com/v/mac/home/by/images/overview/consider/mac_security__gfwda10khdym_xlarge.jpg")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                            <div>
                    ...
                    <SwiperSlide className='pt-5 pb-5'>
                        {/* Card content */}
                        <div className="w-[372px] h-[680px] mx-3 rounded-3xl bg-white shadow-md p-4 transition-transform duration-700 transform hover:scale-105 flex flex-col overflow-hidden relative" style={{ backgroundImage: 'url("https://www.apple.com/v/mac/home/by/images/overview/consider/mac_durability__epiwcuk7zkeq_xlarge.jpg")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                            <div>
            ...
            <div className="grid grid-cols-5 gap-8 p-32">
                ...
                <div className="col-span-1 flex flex-col items-center">
                    {/* Product Image */}
                    <img className="w-full mb-5 hover:cursor-pointer transition-transform duration-700 transform hover:scale-105" src="https://www.apple.com/v/mac/home/by/images/overview/select/product_tile_mba_13_15__fx2g3qlubdym_large.png" alt="Product 1" />
                    {/* Product Details */}
                ...
                <div className="col-span-1 flex flex-col items-center">
                    {/* Product Image */}
                    <img className="w-full mb-10 hover:cursor-pointer transition-transform duration-700 transform hover:scale-105" src="https://www.apple.com/v/mac/home/by/images/overview/select/product_tile_mbp_14_16__bkl8zusnkpw2_large.png" alt="Product 1" />
                    {/* Product Details */}
                    <div className="mt-4 text-center flex flex-col">
            ...
            <div className='flex items-center'>
                <div className="flex flex-col flex-grow break-words mx-12 pl-16 pr-96 text-left">
                    <h1 className="flex text-6xl font-medium text-gray-950">Why Apple is the best
            ...
            <div className='mt-5 mx-8 pl-24'>
                ...
                >
                    ...
                    <SwiperSlide className='pt-5 pb-5'>
                        ...
                        <div className="w-[370px] h-[310px] mx-3 rounded-3xl bg-white shadow-md p-4 transition-transform duration-700 transform hover:scale-105 flex flex-col hover:cursor-pointer relative">
                            <div className="m-3 mt-5">
                                <img src="https://www.apple.com/v/mac/home/by/images/overview/incentive/icon_apple_card__fa68csvawtei_large.png" alt="Title 1" className="w-auto h-auto max-w-full max-h-full" />
                            </div>
                            <div className="">
                                <h3 className="text-2xl font-semibold m-3">Pay over time, <br /> interest-free.</h3>
                    ...
                    <SwiperSlide className='pt-5 pb-5'>
                        ...
                        <div className="w-[370px] h-[310px] mx-3 rounded-3xl bg-white shadow-md p-4 transition-transform duration-700 transform hover:scale-105 flex flex-col hover:cursor-pointer relative">
                            <div className="m-3 mt-5">
                                <img src="https://www.apple.com/v/mac/home/by/images/overview/incentive/icon_specialist_alt__fht15dmiclei_large.png" alt="Title 1" className="w-auto h-auto max-w-full max-h-full" />
                            </div>
                            <div className="">
                    ...
                    <SwiperSlide className='pt-5 pb-5'>
                        ...
                        <div className="w-[370px] h-[310px] mx-3 rounded-3xl bg-white shadow-md p-4 transition-transform duration-700 transform hover:scale-105 flex flex-col hover:cursor-pointer relative">
                            <div className="m-3 mt-5">
                                <img src="https://www.apple.com/v/mac/home/by/images/overview/incentive/icon_trade_in__ca5f20mux4b6_large.png" alt="Title 1" className="w-auto h-auto max-w-full max-h-full" />
                            </div>
                            <div className="">
                    ...
                    <SwiperSlide className='pt-5 pb-5'>
                        ...
                        <div className="w-[370px] h-[310px] mx-3 rounded-3xl bg-white shadow-md p-4 transition-transform duration-700 transform hover:scale-105 flex flex-col hover:cursor-pointer relative">
                            <div className="m-3 mt-5">
                                <img src="https://www.apple.com/v/mac/home/by/images/overview/incentive/icon_customize__b6w4i5ax89py_large.png" alt="Title 1" className="w-auto h-auto max-w-full max-h-full" />
                            </div>
                            <div className="">
                    ...
                    <SwiperSlide className='pt-5 pb-5'>
                        ...
                        <div className="w-[370px] h-[310px] mx-3 rounded-3xl bg-white shadow-md p-4 transition-transform duration-700 transform hover:scale-105 flex flex-col hover:cursor-pointer relative">
                            <div className="m-3 mt-5">
                                <img src="https://www.apple.com/v/mac/home/by/images/overview/incentive/icon_delivery__fyzranm9416y_large.png" alt="Title 1" className="w-auto h-auto max-w-full max-h-full" />
                            </div>
                            <div className="">
                    ...
                    <SwiperSlide className='pt-5 pb-5'>
                        ...
                        <div className="w-[370px] h-[310px] mx-3 rounded-3xl bg-white shadow-md p-4 transition-transform duration-700 transform hover:scale-105 flex flex-col hover:cursor-pointer relative">
                            <div className="m-3 mt-5">
                                <img src="https://www.apple.com/v/mac/home/by/images/overview/incentive/icon_person__bayst2x5jyya_large.png" alt="Title 1" className="w-auto h-auto max-w-full max-h-full" />
                            </div>
                            <div className="">
                                <h3 className="text-2xl font-semibold m-3">Pay over time, <br /> interest-free.</h3>
                                <h5 className='mx-3 text-md font-normal'>When you choose to check out with Apple Card Monthly Installments.</h5>
                    ...
                    <SwiperSlide className='pt-5 pb-5'>
                        ...
                        <div className="w-[370px] h-[310px] mx-3 rounded-3xl bg-white shadow-md p-4 transition-transform duration-700 transform hover:scale-105 flex flex-col hover:cursor-pointer relative">
                            <div className="m-3 mt-5">
                                <img src="https://www.apple.com/v/mac/home/by/images/overview/incentive/icon_asa__urbsp7b9ktuq_large.png" alt="Title 1" className="w-auto h-auto max-w-full max-h-full" />
                            </div>
                            <div className="">
                                <h3 className="text-2xl font-semibold m-3">Pay over time, <br /> interest-free.</h3>
                                <h5 className='mx-3 text-md font-normal'>When you choose to check out with Apple Card Monthly Installments.</h5>
                            ...
                            <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')} style={{ boxShadow: 'none' }}>
                                ...
                                <AccordionDetails style={{ backgroundColor: '#E5E5E5' }}>
                                    <Typography align="center" >
                                        You can answer calls or messages from your iPhone directly on your Mac. Copy images, video, or text on your iPhone, then paste into another app on your nearby Mac. With iCloud, you can access your favorite files from either your iPhone or your Mac. And so much more.
                                    </Typography>
                                </AccordionDetails>
                            </Accordion>
                        </div>
