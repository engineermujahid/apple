        ...
        <div className="bg-neutral-100">
            ...
            < div className="w-full h-screen mt-8 relative" style={{ backgroundImage: `url("${iphone15promedium}")`, backgroundSize: 'cover', backgroundPosition: 'center' }
                ...
                <div className='absolute top-10 left-0 right-0 text-center pt-8'>
                    ...
                    <div className='inline-block mt-4'>
                        <button className='text-white bg-blue-600 hover:bg-blue-500 hover:cursor-pointer py-2 px-4 rounded-3xl inline-block' onClick={() => handleBuy('iPhone 15 Pro', 999)}>Buy</button>
                    </div>
            ...
            < div className="w-full h-screen relative" style={{ backgroundImage: `url("${iphoneimg2}")`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                <div className='absolute top-10 left-0 right-0 text-center pt-8'>
                    ...
                    <div className='inline-block mt-4'>
                        <button className='text-white bg-blue-600 hover:bg-blue-500 hover:cursor-pointer py-2 px-4 rounded-3xl inline-block' onClick={() => handleBuy('iPhone 15', 799)}>Buy</button>
                    </div>
                    <h4 className='text-blue-500 hover:underline hover:cursor-pointer mt-4 font-light text-xl'>Learn more &gt;</h4>
                </div>
            </div >
            ...
            < div className="w-full h-screen relative" style={{ backgroundImage: `url("${iphoneimg3}")`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                <div className='absolute top-1/3 left-1/4 transform -translate-x-1/2 w-1/2 pt-8'>
                    <div className="flex flex-col items-center">
                        ...
                        <div className='inline-block mt-4'>
                            <button className='text-white bg-blue-600 hover:bg-blue-500 hover:cursor-pointer py-2 px-4 rounded-3xl inline-block' onClick={() => handleBuy('iPhone SE', 429)}>Buy</button>
                        </div>
                        <h4 className='text-blue-500 hover:underline hover:cursor-pointer mt-4 font-light text-xl'>Learn more &gt;</h4>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-4 gap-8 p-32 mx-80">
                ...
                <div className="col-span-1 flex flex-col items-center">
                    ...
                    <div className="text-center flex flex-col">
                        ...
                        <div className='flex flex-col mt-4 items-center'>
                            <button className='bg-blue-600 text-white rounded-3xl px-4 py-1 hover:bg-blue-500 hover:cursor-pointer' onClick={() => handleBuy('iPhone 15 Pro', 999)}>Buy</button>
                        ...
                        <h3 className='font-normal text-sm leading-6'>Super Retina XDR display <br /> ProMotion technology <br /> Always-On display</h3>

                        <img className='w-auto h-auto mx-auto mt-8' src={iphoneimg6} alt="iphone figure" />

                        <h3 className='font-normal text-md leading-6'>Titanium with textured
                            <br />matte glass back</h3>
                        ...
                        <h3 className='font-normal text-md leading-6'>Dynamic Island
                            <br />A magical way to interact with iPhone</h3>

                        <img className='w-auto h-auto mx-auto mt-8' src={iphoneimg8} alt="iphone figure" />

                        <h3 className='font-normal text-md leading-6'>A17 Pro chip
                            <br /> with 6-core GPU</h3>

                        <img className='w-auto h-auto mx-auto mt-8' src={iphoneimg9} alt="iphone figure" />

                        <h3 className='font-normal text-md leading-6'>Pro camera system
                            <br />
                            ...
                            <br />
                            Next-generation portraits with Focus and Depth Control</h3>
                        ...
                        <h3 className='font-normal text-md leading-6'>Emergency SOS
                            <br />
                        ...
                        <h3 className='font-normal text-md leading-6'>Up to 29 hours
                            <br />video playback6</h3>

                        <img className='w-auto h-auto mx-auto mt-8' src={iphoneimg13} alt="iphone figure" />

                        <h3 className='font-normal text-md leading-6'>USB-C
                            <br />
                            Supports USB 3 for
                            <br />
                            up to 20x faster transfers7</h3>
                ...
                <div className="col-span-1 flex flex-col items-center">
                    ...
                    <div className="text-center flex flex-col">
                        ...
                        <h2 className="text-xl font-medium mt-8">6.7″ or 6.1″</h2>
                        <h3 className='font-normal text-sm leading-6'>Super Retina XDR display <br />-<br />-</h3>
            ...
            <div className='flex justify-center -mt-20'>
                <h2 className='text-blue-500 hover:underline hover:cursor-pointer text-xl font-medium hover:underline hover:cursor-pointer mx-5'>Compare all iPhone models &gt;</h2>
                <h2 className='text-blue-500 hover:underline hover:cursor-pointer text-xl font-medium hover:underline hover:cursor-pointer mx-5'>Shop iPhone &gt;</h2>
            </div>
            ...
            <div className='grid grid-cols-3 gap-4 p-20 mx-40'>
                <div className="flex flex-col items-center bg-white overflow-hidden">
                    <div>
                        <h1 className='mx-5 mt-10 text-2xl font-medium text-center'>Get $180–$630 in <br /> credit when you trade <br /> in iPhone 11 or higher.</h1>
                ...
                <div className="flex flex-col items-center bg-white overflow-hidden">
                    <div>
                        ...
                        <h1 className='mx-5 mb-5 mt-2 text-2xl font-medium text-center'> iPhone carrier deals. <br />Right here at Apple. <br />For as low as $0.</h1>
                    </div>
                    ...
                    <div>
                        ...
                        <h3 className='text-xs text-gray-600 font-normal my-12 mx-24 text-center'>Includes trade‑in and carrier credits. <br /> AT&T: up to $1000. T‑Mobile: up to $800. <br /> Verizon: up to $830.</h3>
                    </div>
                </div>

                <div className="flex flex-col items-center bg-white overflow-hidden">
                    <div>
                        <h1 className='mx-5 mt-8 text-2xl font-medium text-center'> Pay 0% APR over <br /> 24 months with <br /> Apple Card.</h1>
                        <h3 className='text-md text-gray-600 font-normal mt-4 text-center'>Choose Apple Card Monthly <br /> Installments when you check out.**</h3>
                ...
                <div className='col-span-3 bg-white relative' style={{
                    backgroundImage: `url(${whyAppleIsTheBest})`,
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    minHeight: '500px',
                }}>
                    <h1 className='mx-5 mb-5 mt-20 text-4xl font-semibold text-center'>Why Apple is the best <br /> place to buy iPhone.</h1>
                    <h2 className='mx-[29rem] text-xl text-center my-6'>You can choose a payment option that works for you, pay less with a trade‑in, connect your new iPhone to your carrier, and get set up quickly.
                        You can also chat with a Specialist anytime.</h2>
